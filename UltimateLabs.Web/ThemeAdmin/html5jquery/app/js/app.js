...
(function() {
    ...
    function runSweetAlert() {
        ...
        $('#swal-CreateProfile').on('click', function (e) {
            e.preventDefault();
            swal('Exito', 'Perfil creado exitosamente...!', 'success');
    ...
    function formValidation() {
        ...
        $('#form-example').validate({
            ...
            submitHandler: function (/*form*/) {
                ...
                var clase = document.getElementById('profile');
                clase.classList.remove("in", "active");
                document.getElementById('documents').className += ' in active';

                var tabProfile = document.getElementById('liProfile');
                tabProfile.classList.remove("active");
                document.getElementById('liDocs').className = 'active';
            }
        });

        $('#dropzone-area').validate({
            //errorPlacement: errorPlacementInput,
            //// Form rules
            //rules: {
            //    sometext: {
